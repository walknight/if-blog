...
*/
$config['tables']['users']           = 'if_users';
$config['tables']['groups']          = 'if_groups';
$config['tables']['users_groups']    = 'if_users_groups';
$config['tables']['login_attempts']  = 'if_login_attempts';
 ...
 */
$config['site_title']                 = "if-blog";       // Site Title, example.com
$config['admin_email']                = "admin@ifcode.my.id"; // Admin Email, admin@example.com
